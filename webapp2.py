...
#: Base HTTP exception, set here as static interface.
...
# Defer importing google.appengine.ext.webapp.util until every static symbol
# has been defined since google.appengine.ext.webapp in App Engine Python 2.7
# runtime imports this module to provide its static interface.
try:
